  ...
  public static void main(String[] args) 
  {
        ...
        else 
        {
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) 
            {
                ...
                sourcePath = reader.readLine().trim();			// 	C:/Users/zahur/Desktop/Github/programs/src/com/learning/core/day10/Source1.txt

                System.out.print("Enter destination file path: ");
                destinationPath = reader.readLine().trim();		//	C:/Users/zahur/Desktop/Github/programs/src/com/learning/core/day10/Destination1.txt
            } 
            catch (IOException e) 
            {
